  ...
  return (
    <Container fluid className="p-4">
      ...
      <p className="colour fs-4">
        Over the years I have built many projects to help develop my skills as a
        developer using all sorts of technology, libraries, frameworks and
        tools.
      </p>
      <ProjectCard
        title="JWT Validator"
        description="The goal of this library is to simplify the validation of a JWT in C# and abstract away from the complex internal libraries 
        I developed this library becasue of dealing with the reocurring issue of developers strugging with the validation of an ID token after a 
        sucessful OAuth login. There are three main parts to this library. 1. A builder to constrct what parts of the JWT need validating. 2. 
        Methods that return whether the JWT is valid or not as well as a dictionary of what JWT contains. 3. Dictionary extension methods to 
        help handle the results."
      ...
      <br></br>
      <p className="colour fs-4">
        After my first year of university, I built all sorts of applications in
        Java to help develop my foundation knowledge as a developer. Such as
        clocks, calculators, text editors, track archery scoring, track table
        tennis matches, encoding and decoding messages, binary converters, code
        breakers and traffic light systems.
      </p>
    </Container>
  );
};
