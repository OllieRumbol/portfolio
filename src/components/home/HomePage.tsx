...
const HomePage = () => {
  ...
  return (
    <div className='p-4'>
      ...
      <p className='colour fs-4'>
        To try something a little different, this react website was built using TypeScript instead of JavaScript. There were a few reasons
        behind this. It was fun to learn new technologies and ideas. TS adds a huge amount of safety to the project and requires null/
        undefine checks. I always try to write the most generic code I can so it's easier to migrate the project over to a newer framework/
      ...
      <Accordion defaultActiveKey="0">
        <Card bg='dark' className='colour'>
          <Card.Header className='text-center'>
            <Accordion.Toggle className='fs-4' as={Button} variant="success" eventKey="0">
        ...
        <Card bg='dark' className='colour'>
          <Card.Header className='text-center'>
            <Accordion.Toggle className='fs-4' as={Button} variant="success" eventKey="1">
        ...
        <Card bg='dark' className='colour'>
          <Card.Header className='text-center'>
            <Accordion.Toggle className='fs-4' as={Button} variant="success" eventKey="2">
